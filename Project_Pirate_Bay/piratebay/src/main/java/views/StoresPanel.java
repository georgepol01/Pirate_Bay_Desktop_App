...
public class StoresPanel extends javax.swing.JPanel implements IRestorableJPanel{
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Πίνακας Καταστημάτων");
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        StoresAddFrame addFrame = new StoresAddFrame();
    ...
    private void removeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeButtonActionPerformed
        StoresRemoveFrame addFrame = new StoresRemoveFrame();
        addFrame.setVisible(true);
        addFrame.setLocationRelativeTo(null);
    }//GEN-LAST:event_removeButtonActionPerformed

    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        StoresSearchFrame addFrame = new StoresSearchFrame();
        addFrame.setVisible(true);
        addFrame.setLocationRelativeTo(null);
    }//GEN-LAST:event_editButtonActionPerformed
     
      public static void refreshStoresTable(){
                    DefaultTableModel model = (DefaultTableModel) StoresPanel.storesTable.getModel();
                    model.setRowCount(0);
                try {    
                            dbConnection = DriverManager.getConnection (url, username, passwd);
                            String searchString = "SELECT * FROM vtablerefresh()";
                            prst= dbConnection.prepareStatement(searchString);
                            rs = prst.executeQuery();
                            while(rs.next()){
                                    String tvid = String.valueOf(rs.getInt(1));
                                    String taddress=rs.getString(2);
                                    String tphone =rs.getString(3);

                                    String tbData [] = {tvid,taddress,tphone};
                                    model.addRow(tbData);
                             }
                            rs.close();
                            prst.close();
    ...
    public static javax.swing.JTable storesTable;
