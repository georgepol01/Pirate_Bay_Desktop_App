...
public class StoresRemoveFrame extends javax.swing.JFrame {

    public StoresRemoveFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        VIDFieldRemove = new javax.swing.JTextField();
        ...
        jLabel1.setText("Αφαίρεση Καταστήματος");

        VIDFieldRemove.setBackground(new java.awt.Color(255, 255, 255));
        VIDFieldRemove.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        VIDFieldRemove.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                VIDFieldRemoveActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(VIDFieldRemove, javax.swing.GroupLayout.PREFERRED_SIZE, 163, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(VIDFieldRemove, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void VIDFieldRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VIDFieldRemoveActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_VIDFieldRemoveActionPerformed
    ...
    private void confirmButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmButtonActionPerformed
       int vid = Integer.valueOf(VIDFieldRemove.getText());
        try {
            dbConnection = DriverManager.getConnection (url, username, passwd);
            String removeString = "SELECT storedelete(?)";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StoresRemoveFrame().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTextField VIDFieldRemove;
